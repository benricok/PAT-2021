...
interface
uses
  Windows, System.Hash, System.Classes, SysUtils, Math, Vcl.Dialogs;
...
function TCrypto.GenerateKey(iMin, iMax : integer; bUpChar, bLowChar, bNumbers, bSpecial : boolean) : String;
Var
...
function TCrypto.Encrypt(sMessage, sKeyIn : string) : string;
Var
...
function TCrypto.encrypt_vigenere(sMsg, sKeyIn : String) : String;
Var
  i, k : integer;
...
function TCrypto.decrypt_vigenere(sEncryptedMsg, sNewKey : String) : String;
Var
  i, k : integer;
...
//Generate new key
function TCrypto.extend_key(sMsg, sKeyIn : String) : String;
Var
  i, j, k : integer;
  sNewKeyGen : String;
